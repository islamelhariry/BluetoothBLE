...
//****You implement this function as part of Lab 6*****
  ...
  uuid&0xFF,
	...
	SetFCS(msg);		// FCS (calculated by SetFCS)
}
...
//****You implement this function as part of Lab 6*****
  ...
  msg[6] = 0x03; // GATT Read Permissions
	msg[7] = 0x01;
...
//****You implement this function as part of Lab 6*****
  ...
  msg[6] = i;			// length
	...
	msg[9+i] = 0x50; 	// DEFAULT_DESIRED_MIN_CONN_INTERVAL
	msg[10+i] = 0x00; 	// DEFAULT_DESIRED_MAX_CONN_INTERVAL
	msg[11+i] = 0x20; 
...
//****You implement this function as part of Lab 6*****
  ...
  interval&0xFF,      // Advertising Interval (100 * 0.625 ms=62.5ms)
  interval>>8,
